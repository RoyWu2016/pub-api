...
public class RedisUtil {
	...
	public static final int hour = 60 * 60;         //1 hour
...
//			jedis.get("testKey");
	...
	/**
	 * init the redis conneciton pool
	 */
	...
	*/
	...
	public synchronized static String setWithExpire(final String key, final String value, int expiry) {
		Jedis jedis = getJedis();
		try {
