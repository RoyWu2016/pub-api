...
public class TokenJWTDaoImpl {
    ...
    private static final String AES_KEY_PATH = "/usr/local/tomcat7_8080/conf/sso-sig/server-token.aes";
    private static final String ECC_PRIV_KEY_PATH = "/usr/local/tomcat7_8080/conf/sso-sig/server-sig.ecc";
    private static final String ECC_PUB_KEY_PATH = "/usr/local/tomcat7_8080/conf/sso-sig/server-sig.ecc.pub";
