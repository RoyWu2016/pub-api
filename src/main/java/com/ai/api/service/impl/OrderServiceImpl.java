...
//	private CustomerDao customerDao;
	...
	*/
	...
	@Override
	public List<SimpleOrderSearchBean> searchOrders(String userId, String orderStatus, String pageSize, String pageNumber, String direction) throws IOException,
			AIException {
		String companyId = "";
		String parentId = "";
		UserBean user = userService.getCustById(userId);
		if (null!=user){
			parentId = user.getCompany().getParentCompanyId();
			if (parentId == null) parentId = "";
			companyId = "52FD4C0FC6215A1D48257C660003A61F";//user.getCompany().getId();
		}
		return orderDao.searchOrders(userId, companyId, orderStatus, pageSize, pageNumber, direction);
	}
